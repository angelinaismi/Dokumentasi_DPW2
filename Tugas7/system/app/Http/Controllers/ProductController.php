...
class ProductController extends Controller {
    ...
    function store(){
         ...
         return redirect('admin/product')->with('success', 'Data Successful Get Add');
    }      
    ...
    function update(Product $product){
      ...
      return redirect('admin/product')->with('success', 'Data Successful Get Edit');
    }
    function destroy(Product $product){
        $product->delete();

        return redirect('admin/product')->with('danger', 'Data Successful Get Delete');
    }
