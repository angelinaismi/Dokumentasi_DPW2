...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        ...
        <span class="brand-text font-weight-light">SAStore</span>
    </a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/product') }}" class="nav-link {{ checkRouteActive('admin/product') }}">
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/category') }}" class="nav-link {{ checkRouteActive('admin/category') }}">
